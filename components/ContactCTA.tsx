            ...
            <div className="container mx-auto px-4 lg:px-8 max-w-5xl relative z-10">
                <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 md:p-8 lg:p-10 flex flex-col lg:flex-row items-center justify-between gap-8 hover:shadow-2xl transition-shadow duration-500">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-bg text-primary font-semibold text-xs mb-4 uppercase tracking-wider border border-blue-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                            <Link href="/contact" className="inline-flex items-center justify-center px-6 py-3 text-sm font-bold text-white bg-primary rounded-xl hover:bg-primary-hover transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                                Contact Us Now
                            </Link>
                        </div>
                    </div>
